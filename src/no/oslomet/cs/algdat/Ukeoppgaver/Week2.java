...
public class Week2 {
    ...
    public static void main(String[] args) {
        ...
        if (a[y] > a[z]) {
            System.out.println("Y er stÃ¸rst: " + y);
        }
        else {
            System.out.println("Z er stÃ¸rst: " + z);
        }
    ...
    public static int maksBinaryTree(int[] a) {
        ...
        //Skriv ut noen potensielle kamper i motsatt rekkefÃ¸lge
        System.out.println("Potensielle kamper i b (motsatt for-lÃ¸kke):");
        ...
        //Snu for-lÃ¸kken
        System.out.println("KjÃ¸rer kamper");
